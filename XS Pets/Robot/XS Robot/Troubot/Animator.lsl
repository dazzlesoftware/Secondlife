...
//You can now animate any object, with just one script!
//  Setup is very simple. Just drop the script and a blank notecard into the object, click the object, and give your animation a name.
//   Move all the prims around, and click Record//
//  When done, click the Animation Name, and watch it play back every move!

// Downloaded from : http://www.free-lsl-scripts.com/cgi/freescripts.plx?ID=1519

// This program is free software; you can redistribute it and/or modify it.
// Additional Licenses may apply that prevent you from selling this code
